...
class diagram_t{
	...
	public:
	diagram_t(std::vector<line_t> l=*(new std::vector<line_t>), std::vector<point_t> p=*(new std::vector<point_t>), std::vector<polygon_t> po=*(new std::vector<polygon_t>)) : lines(l), points(p), polygons(po) {};
